...
# (Fixed navigation buttons for date selection)
...
# (keeping all your existing helper functions unchanged...)
# safe_to_datetime, normalize_rate_input, denormalize_to_percent, np_busdays_exclusive,
# calculate_ttm, build_std_grid_by_rule, row_to_std_grid, forecast_pcs_var,
# forecast_pcs_arima, build_pca_matrix, calculate_raw_metrics
